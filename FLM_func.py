...
class FLM2():
    ...
    def fit(self, daily_avg, binarize=False, verbose=False):
        ...
        """
        freq_minute=int(self.sampling_freq[0:2])
        self.__nsamples = int(1440/freq_minute)
        # unit= 1min
        ...
        if self.__basis == 'fourier':
            ...
            self.__beta['name'] = results.params
        ...
        # Spline
            ...
            self.__beta['name'] = list(
                splrep(t, daily_avg, k=k)
            )

    def evaluate(self, daiily_avg, r=10):
        ...
        # Spline
            ...
            y_est = BSpline(*self.beta['name'], extrapolate=False)(t)
            return y_est
    ...
    def smooth(self, daily_avg, binarize=False, method='scott', verbose=False):
        ...
        bw = _get_kernel_size(daily_avg, method=method)
